#!/usr/bin/env python3
"""
Phase 9b ADK migration test for HR Leave Assistant agent.
Tests ADK component verification and original Phase 8b test cases.
"""
import os
import sys
...
print("=" * 70)
print("PHASE 9b - HR LEAVE AGENT ADK MIGRATION TEST")
print("=" * 70)
...
assert len(agent.adk_tools) == 4, f"Expected 4 FunctionTools, got {len(agent.adk_tools)}"
